        ...
        <div class="about__grid">
            ...
            <div class="about__visual">
                <div class="about__card">
                    ...
                    <div class="about__ring about__ring--2"></div>
                    <div class="about__ring about__ring--3"></div>

                    <div class="about__badge">8+ Years</div>
            ...
            <div class="about__copy">
                ...
                <div class="about__highlights">
                    <div class="chip">Performance Enhancement</div>
                    <div class="chip">Movement Analysis</div>
                    <div class="chip">Sports Nutrition</div>
                    <div class="chip">Injury Prevention</div>
                </div>
            </div>
        </div>
    </div>
